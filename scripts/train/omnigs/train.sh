...
cd ../../..
cd codes
configs_path="/home/zliu/Project2025/FeedStereoGS/codes/configs/OmniScene/omnigs_vanilla_first_LiDAR_as_reference.py"
work_dir="/data1/zliu/feedforward_outputs_revision/OmniScene_2_Views/MetricV2/First_LiDAR_As_Ref/saved_models"
resume_from="None"
