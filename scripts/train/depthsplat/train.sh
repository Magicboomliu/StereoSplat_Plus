...
cd ../../..
cd codes
configs_path="/home/zliu/Project2025/FeedStereoGS/codes/configs/DepthSplat/depthsplat_gs_revised_firstcam_as_ref_no_offset.py"
work_dir="/data1/zliu/feedforward_outputs_new/depthsplat_revised_FirstCam_ref_no_offset/saved_models"
#resume_from="/data1/zliu/temp_for_0617/DepthSplat/SH0_Version/checkpoint-99000/"
resume_from="None"
#configs 
# - Single GPU YAML: accelerate_config_singleGPU.yaml
...
cd ../../..
cd codes
configs_path="/home/zliu/Project2025/FeedStereoGS/codes/configs/DepthSplat/depthsplat_gs_revised_firstcam_as_ref_with_offset.py"
work_dir="/data1/zliu/feedforward_outputs_new/depthsplat_revised_FirstCam_ref_with_offset/saved_models"
