...
#configs 
# - Single GPU YAML: accelerate_config_singleGPU0.yaml
# - Multi GPUs YAML: accelerate_config.yaml


nvidia-smi

TORCH_USE_CUDA_DSA=1 CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=0 accelerate launch --config-file accelerate_config_singleGPU0.yaml  train_kitti360_stereo.py \
