...
# - Multi GPUs YAML: accelerate_config.yaml
export PYTORCH_CUDA_ALLOC_CONF=max_split_size_mb:64
TORCH_USE_CUDA_DSA=1 CUDA_LAUNCH_BLOCKING=1 accelerate launch --config-file accelerate_config_singleGPU.yaml train_kitti360_stereo_depthsplat_revised.py \
    --py-config $configs_path \
    --work-dir  $work_dir \
    --resume-from $resume_from
}
