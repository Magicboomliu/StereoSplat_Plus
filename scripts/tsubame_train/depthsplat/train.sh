...
TRAIN_KITTI360_DepthSplat_Revised_First_LiDAR_As_Ref_No_3D_Offset(){

cd ../../..
cd codes

configs_path="/home/2/ux04482/FeedStereoGS/codes/configs/Tsubame_Version/DepthSplat/ds_kitti360_revised_first_lidar_as_ref_no_offset.py"
work_dir="/gs/FeedForwardGS_New/DepthSplat/First_LiDAR_As_Ref_No_Offset/saved_models"
resume_from="None"
