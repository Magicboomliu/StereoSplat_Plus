...
work_dir="/data1/zliu/temp_for_0617/Vis_And_Evals/VolumeFusion/rendered_videos"
...
TORCH_USE_CUDA_DSA=1 CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=0 accelerate launch --config-file accelerate_config_singleGPU.yaml models_lab/volumefusion/renderd_video_origin.py \
