...
configs_path="/home/zliu/IROS2026/Diff-StereoSplat/codes/configs/MVSplat/mvsplat_vanilla_first_lidar.py"
output_folder="/data1/zliu/IROS26/Compared_With_Others/MVSplat_2Views/Feedforward_Views"
...
TORCH_USE_CUDA_DSA=1 CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=0 accelerate launch --config-file accelerate_config_singleGPU.yaml mvsplat/rendered_all_forward_views_vanilla.py \
