Generating_DifiX_Finetuning_Dataset(){
...
output_folder="/data1/zliu/IROS26/Compared_With_Others/Diff-StereoSplat/difix_finetuning_dataset"
...
python stereosplat/generating_difix_training_data.py \
