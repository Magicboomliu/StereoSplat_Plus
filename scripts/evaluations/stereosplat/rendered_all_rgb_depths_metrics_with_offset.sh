...
output_folder="/data1/zliu/IROS26/Compared_With_Others/StereoSplat_2Views/forward_views"
...
TORCH_USE_CUDA_DSA=1 CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=0 accelerate launch --config-file accelerate_config_singleGPU.yaml stereosplat/rendered_all_rgbs_and_depths_inside_bin.py \
