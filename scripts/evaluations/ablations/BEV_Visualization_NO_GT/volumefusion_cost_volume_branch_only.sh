...
output_folder="/data1/zliu/feedforward_outputs_ablations/Cost_Volume_Branch_Only/Additional_BEV_Novel_Views"
...
pretrained_model_path="/data1/zliu/feedforward_outputs_ablations/Cost_Volume_Branch_Only/saved_models/checkpoint-24000/"



export PYTORCH_CUDA_ALLOC_CONF=max_split_size_mb:64
TORCH_USE_CUDA_DSA=1 CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=0 accelerate launch --config-file accelerate_config_singleGPU.yaml ablations/BEV_Visualization_NO_GT/volumefusion_cost_volume_branch_only.py \
