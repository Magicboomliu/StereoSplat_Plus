...
output_folder="/data1/zliu/feedforward_outputs_ablations/Training_2_Views/Additional_BEV_Novel_Views"
...
TORCH_USE_CUDA_DSA=1 CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=0 accelerate launch --config-file accelerate_config_singleGPU.yaml ablations/BEV_Visualization_NO_GT/volumefusion_train_first_2_views.py \
