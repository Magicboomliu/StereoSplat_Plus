Baseline_Preserving_Fusion_Hard_Alpha_Fusion(){
...
output_folder="/data1/zliu/IROS26/Compared_With_Others/StereoSplat_Plus/Baseline_Preserving_Fusion/Center_Last/Hard_Alpha_Fusion"
...
TORCH_USE_CUDA_DSA=1 CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=0 accelerate launch --config-file gpu_config_0.yaml stereosplat_plus/stereosplat_baseline_perserving_fusion_hard_alpha_fusion.py \
