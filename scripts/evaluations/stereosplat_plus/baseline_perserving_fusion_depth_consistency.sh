Baseline_Preserving_Fusion_Simple_Depth_Consistency(){
...
output_folder="/data1/zliu/IROS26/Compared_With_Others/StereoSplat_Plus/Baseline_Preserving_Fusion/Center_Last/Depth_Consistency"
...
TORCH_USE_CUDA_DSA=1 CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=0 accelerate launch --config-file gpu_config_1.yaml stereosplat_plus/stereosplat_baseline_perserving_fusion_depth_consistency.py \
