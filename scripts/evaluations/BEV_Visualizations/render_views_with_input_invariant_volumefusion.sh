...
output_folder="/data1/zliu/forward_outputs_compared_with_others/input_invariant_volumefusion/bev_views"
...
TORCH_USE_CUDA_DSA=1 CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=0 accelerate launch --config-file accelerate_config_singleGPU.yaml volumeufison/rendered_novel_bev_views.py \
