...
output_folder="/data/zliu/forward_outputs_compared_with_others/pixelsplat/bev_views"
val_filelist="/home/Project2025/FeedStereoGS/filenames/kitti360/train_complete/val.txt"
demo_filelist="/home/Project2025/FeedStereoGS/filenames/kitti360/train_complete/demo_more.txt"
...
TORCH_USE_CUDA_DSA=1 CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=0 accelerate launch --config-file accelerate_config_singleGPU.yaml pixelspalt/rendered_all_bev_views_vanilla.py \
