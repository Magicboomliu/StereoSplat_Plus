...
output_folder="/data1/zliu/IROS26/Compared_With_Others/Diff-StereoSplat/20260315_Difix_Validation/All_Range_Metrics"
...
TORCH_USE_CUDA_DSA=1 CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=0 accelerate launch --config-file gpu_config_1.yaml difix3d/validation_evaluation_with_custom_view.py \
