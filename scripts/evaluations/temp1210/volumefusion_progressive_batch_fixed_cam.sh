VolumeFusion_Progressive_Batch_Fixed_CamPose(){
...
output_folder="/data1/zliu/feedforward_outputs_ablations/Progressive_Inference/Updated_1208/Fixed_Camera_Pose/Progressive_Batch_Finetuned/Testing"
...
demo_filelist="/home/zliu/Project2025/FeedforwardGS_Ablations/FeedStereoGS/filenames/kitti360/trainval/demo.txt"
...
TORCH_USE_CUDA_DSA=1 CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=0 accelerate launch --config-file accelerate_config_singleGPU.yaml fixed_inference_c2w/volumefusion_progressive_batch.py \
