Progressive_Twice_Diffix3D_Gradually(){
...
use_difix_type="huggingface"


export PYTORCH_CUDA_ALLOC_CONF=max_split_size_mb:64
TORCH_USE_CUDA_DSA=1 CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=0 accelerate launch --config-file accelerate_config_singleGPU.yaml ablations/volumefusion_with_difix3d_gradually.py \
