...
work_dir="../../../../outputs/models/all/withconf/stereosplat_plus_conf"
output_dir="../../../../outputs/logs/all/withconf/stereosplat_plus_conf"

resume_from=""
stage_1_model_path="/data1/zliu/IROS26/camera_ready_models/Ablations/withconf/stereosplat_plus_plus"
...
Train_StereoSplat_Plus_With_Conf_On_KITTI360               # self-bootstrap (--self_pseudo)
