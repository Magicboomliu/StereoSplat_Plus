...
work_dir="${REPO}/outputs/models/ablations/withconf/stereosplat_conf"
output_dir="${REPO}/outputs/logs/ablations/withconf/stereosplat_conf"
...
wandb_run_name="${WANDB_RUN_NAME:-input_invariant_stereosplat_with_conf_kitti360_ablation}"
