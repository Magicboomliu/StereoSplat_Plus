...
cd ..
dataset_path="/home/zliu/IROS2026/StereoSplat_Plus/difix3d/filenames/Validation_Set/all_results_dict.json"
pretrained_path="/data4/zliu/Difix3D_Output_Results/Refined_Vanilla_Difix3D_PSNR20/checkpoints/model_130001.pkl"
saved_json_path="/home/zliu/IROS2026/StereoSplat_Plus/difix3d/output/finetuned_vanilla_difix3d_psnr20_eval.json"

CUDA_VISIBLE_DEVICES=0 python evals/eval_difix_ref_pipeline.py \
...
CUDA_VISIBLE_DEVICES=1 python evals/eval_difix_ref_pipeline.py \
  --dataset_path $dataset_path \
  --split test \
  --pretrained_path $pretrained_path \
  --device cuda \
