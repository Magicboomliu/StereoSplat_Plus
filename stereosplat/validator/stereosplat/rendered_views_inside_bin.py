...
# Make this script runnable regardless of the current working directory.
# We need access to `tools/` (non-installed helper module) living at the project root.
...
if __name__ == '__main__':
    ...
    # Optional W&B logging (same style as trainer)
