Difix3D_Vanilla_Finetuning_On_High_Quality_Data(){
...
output_dir="/data4/zliu/Difix3D_Output_Results/Debugsss"
config_path="configs/train_difix_ref.yaml"
dataset_path="filenames/Validation_Set/all_results_dict.json"
