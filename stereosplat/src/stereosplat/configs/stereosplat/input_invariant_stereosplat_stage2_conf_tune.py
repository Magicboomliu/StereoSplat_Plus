...
# - Split conf_head (CV + volume); freeze RGB/geometry
# - Loss: fuse pixel + LPIPS + light conf abs anchor (conf_tune_mode=True)
# - Init from an existing Stage2 ckpt via --init_ckpt + weight surgery
# =============================================================================
...
train_filelist = "/home/zliu/IROS2026/Conf/StereoSplat_Plus/stereosplat/filenames/kitti360/train_complete/val.txt"
val_filelist = "/home/zliu/IROS2026/Conf/StereoSplat_Plus/stereosplat/filenames/kitti360/train_complete/val_tiny.txt"
test_filelist = "/home/zliu/IROS2026/Conf/StereoSplat_Plus/stereosplat/filenames/kitti360/train_complete/val_tiny.txt"
...
pc_range = point_cloud_range
pc_xrange = pc_range[3] - pc_range[0]
pc_yrange = pc_range[4] - pc_range[1]
pc_zrange = pc_range[5] - pc_range[2]
...
loss_args = dict(
    ...
    fusion_sup_dict=dict(
        ...
        weight_depth_abs=0.0,
        weight_conf=0.0,
        weight_conf_mv_abs=0.04,
        weight_conf_2v_abs=0.04,
        weight_fusion_sup=2.5,
        weight_fusion_sup_percep=0.4,
        ...
        weight_fusion_2v_margin=0.0,
        fusion_2v_psnr_margin=0.0,
        fusion_2v_psnr_margin_key_views=0.0,
        fusion_2v_margin=0.0,
        weight_fusion_mv_margin=0.0,
        fusion_mv_psnr_margin=0.0,
        fusion_mv_margin=0.0,
        weight_mv_margin=0.0,
        mv_psnr_margin=0.0,
        mv_psnr_margin_key_views=0.0,
        mv_margin=0.0,
        weight_margin_key_views=0.0,
        weight_2v_floor=0.0,
        weight_2v_ceiling=0.0,
    ...
    conf_pick_lambda=40.0,
    cv_sup_dict=dict(
        recon_loss_cv_type="l2",
        weight_recon_cv=0.0,
        weight_perceptual_cv=0.0,
        weight_depth_abs_cv=0.0,
        branch_weight=0.0,
    ),
)
...
model = dict(
    ...
    costvolume_gs=dict(
        ...
        gaussain_head_kwargs=dict(
            ...
            use_split_conf_head=use_split_conf_head,
        ),
    ),
    volume_gs=dict(
        use_checkpoint=use_checkpoint,
