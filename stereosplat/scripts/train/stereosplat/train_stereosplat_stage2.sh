Train_StereoSplat_Stage_2_No_Difix3D_Integrated(){
cd ../../..
...
pixi run -e cu118 accelerate launch --config-file $accelerate_config_path trainer/train_kitti360_stereosplat_stage2_with_difix3d.py \
    --py-config $configs_path \
    --work-dir  $work_dir \
    --resume-from $resume_from \
    --stage_1_model_path $stage_1_model_path \
