...
# gs_conf_voxel_fusion_pose_injection_frozen_stage1_two_models.sh
# 【Stage2 + 冻结 Stage1】3D GS 体素 conf 融合：G_stage1 vs G_stage2 → 单次渲染
# 对应: --training_stage stage2 --eval_mode pixel_fusion --architecture separated --gs_conf_fusion
...
output_folder="/data1/zliu/IROS26/stereosplat_ablations/withconf/stage2/stereosplat_plus/seperated-model/fusion/gs-voxel-conf/${gs_fusion_conf_agg}/base_thresh_${gs_fusion_base_conf_thresh}/margin_${gs_fusion_margin}/voxel_${gs_fusion_voxel_size}/0.5_1.0"
...
# Difix 基座走 HF 缓存；DINOv2 已在 mv_unimatch 里优先读 ~/.cache/torch/hub
