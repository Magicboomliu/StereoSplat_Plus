...
output_folder="/data1/zliu/IROS26/Compared_With_Others_Pixi/results/stereosplat/withconf/stage2_mix_training/"
...
# Stage2 mix-training + conf (latest: checkpoint-235000)
