...
# Unified single-model eval (stage2 checkpoint). Toggle fusion via activate/deactivate.
# Validator: posed_input_view_injected_selected_whole_model_pixel_level.py
