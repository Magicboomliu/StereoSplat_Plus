...
output_folder="/data1/zliu/IROS26/Compared_With_Others_Pixi/results/stereosplat_plus/dev/posed_view_selection_GT_upper_bound/0.50_1.0"
...
# stereosplat/scripts/evaluation/stereosplat_plus/dev/ 
#-> four parents up = stereosplat/ (pixi project root)
...
pretrained_model_path="/data1/zliu/IROS26/Compared_With_Others_Pixi/models/stereosplat/Input_View_Invariant/stage_2_psuedo_gt_mix_training/checkpoint-26000/"
