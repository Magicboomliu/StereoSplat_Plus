...
class PairedDataset(torch.utils.data.Dataset):
    def __init__(self, dataset_path, split, height=288, width=512, tokenizer=None):
    ...
    def __getitem__(self, idx):
        ...
        caption = self.data[img_id]["prompt"] # language prompt
        ...
        img_t = F.normalize(img_t, mean=[0.5], std=[0.5]) # [0, 1] -> [-1, 1]
