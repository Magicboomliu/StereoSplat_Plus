...
output_dir = "/data1/zliu/feedforward_outputs/VolumeFusion_FirstCAM/Debugs/outputs_vis/{}".format(exp_name)
...
# unit is a little bigger than the x_range,y_range and the z_range-> OpenCV coordinate
tpv_h_ = 192
tpv_w_ = 16
tpv_z_ = 192
scale_h = 1
