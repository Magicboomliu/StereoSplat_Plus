...
# exp name
# output directionary
exp_name = "volumefusion_cv_branch_only"
output_dir = "/gs/bs/tga-lab_okmn/zliu/zliu/KITTI360_Ablations/Cost_Volume_Branch_Only/visualization"
dino_resnet50_pretrain_path="/home/2/ux04482/FeedStereoGS/codes/pretrained/dino_resnet50_pretrain.pth"
...
model = dict(
    type='VolumeFusion_CV_Branch_Only',
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            checkpoint=dino_resnet50_pretrain_path,
            prefix=None)),
