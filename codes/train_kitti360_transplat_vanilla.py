...
from transplat.src.model.transplat import Transplat
...
def main(args):
    ...
    # network 
    my_model = Transplat(unimatch_weights_path=cfg.unimatch_weights_path,
                         depthanythingv2_weights_path=cfg.depthanythingv2_weights_path)
