        ...
        if accelerator.is_main_process:            
            for i_iter_val, batch_val in enumerate(val_dataloader):
                ...
                if args.gpus<=1:
                    ...
                    preds, bin_tokens = my_model.forward_video_kitti360(batch_val, cfg.output_dir,cfg)
                else:
                    preds, bin_tokens = my_model.module.forward_video_kitti360(batch_val, cfg.output_dir,cfg)
