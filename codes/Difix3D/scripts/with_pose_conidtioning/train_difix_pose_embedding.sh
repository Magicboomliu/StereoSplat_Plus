Train_Difix_Revision_Ref_Single_GPU_With_Relative_Pose() {
cd ../..
pretrained_model_name_or_path="nvidia/difix_ref"
pretrained_model_path="None"
output_dir="/data4/zliu/Difix3D_Output_Results/Fintuned_Posed_Difix3D_PSNR20"
...
tracker_run_name="posed_difix3d_psnr20"
timestep=199

accelerate launch --mixed_precision=bf16 --config-file gpu_config_3.yaml \
src/train_difix_revision_pose_with_ref.py \
