...
accelerate launch --mixed_precision=bf16 --config-file accelerate_config_singleGPU.yaml src/train_difix_ref.py \
...
accelerate launch --mixed_precision=bf16 --config-file accelerate_config_multiGPU.yaml src/train_difix_ref.py \
    --pretrained_model_name_or_path "$pretrained_model_name_or_path" \
    --pretrained_model_path "$pretrained_model_path" \
    --output_dir "$output_dir" \
    --dataset_path "$dataset_path" \
