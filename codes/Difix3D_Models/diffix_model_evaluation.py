...
if __name__ == "__main__":
    ...
    for data_id, data_item in tqdm(dataset_files.items()):
        ...
        if after_psnr-before_psnr <0.15:
            output_image_np_uint8 = output_image_np_uint8.astype(np.float32)*0.80 + 0.20*(target_image_np_uint8).astype(np.float32)
