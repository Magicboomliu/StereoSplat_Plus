    ...
    while epoch < max_num_epochs:
        ...
        for i_iter, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(my_model):
                ...
                try:
                    if args.gpus <= 1:
                        loss, logs,rendered_fusion_list,rendered_volume_list,rendered_cv_results_list = my_model.forward(batch, 
                                                                                                                         "train", 
                                                                                                                        view_num=view_num,
                        ...
                        loss, logs,rendered_fusion_list,rendered_volume_list,rendered_cv_results_list= my_model.module.forward(batch, 
                                                                                                                               "train", 
                                                                                                                               view_num=view_num,
                                                                                                                               matching_nums=matching_nums,
                                                                                                                               iter=global_iter, 
