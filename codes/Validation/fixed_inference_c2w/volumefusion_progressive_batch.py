...
from models_lab.difix3D.model_no_ref import Difix_No_Ref
from models_lab.difix3D.model_ref import DifixRef
...
def main(args):
    ...
    print("Current Diffusion Model Parameters Now: ")
    print("==============================================")
    print("use_ref: ", args.use_ref)
    print("use_diffix3d: ", args.use_diffix3d)
    print("use_diffix3d_postprocessing: ", args.use_diffix3d_postprocessing)
    print("difix_remote_path: ", args.difix_remote_path)
    print("pretrained_diffix_model_path: ", args.pretrained_diffix_model_path)
    print("use_difix_type: ", args.use_difix_type)
    print("==============================================")
    

    # loading the model here
    if args.use_difix_type == "huggingface":
        difix_model_name = args.difix_remote_path
        difix_model_path = None
    elif args.use_difix_type == "local":
        if args.use_ref:
            difix_model_name = "nvidia/difix_ref"
        else:
            difix_model_name = "nvidia/difix"
    ...
    if args.use_ref:
        pretrained_diffix_model = DifixRef(
            pretrained_name=difix_model_name,
            pretrained_path=difix_model_path,
        ...
        print("Using Reference Images-Involved Diffix3D Model")
    
    else:
        # Initialize the model
        pretrained_diffix_model = Difix_No_Ref(
            pretrained_name=difix_model_name,
            pretrained_path=difix_model_path,
            timestep=args.timestep,
            mv_unet=True if args.use_ref  else False,
        ...
        # set the eval mode.
        pretrained_diffix_model.set_eval()
        print("Using No Ref Images-Involved Diffix3D Model")
...
if __name__ == '__main__':
    ...
    parser.add_argument("--difix_remote_path", type=str, default="nvidia/difix")
    parser.add_argument('--pretrained_diffix_model_path', type=str, default="")
    parser.add_argument('--use_difix_type', type=str, default="huggingface or local")
