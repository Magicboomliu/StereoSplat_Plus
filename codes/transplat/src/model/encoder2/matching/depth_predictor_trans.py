...
# from .utils import UVTransformer, cam_param_encoder
from .utils.cam_param_encoder import cam_param_encoder
from .utils.transformer import UVTransformer
    ...
    def forward(
        ...
        if dino_feature is not None:
            ...
            dino_feature = F.interpolate(
                dino_feature,
                size=(h, w),  # Dynamically match features size instead of hardcoded (64,64)
                mode="bilinear",
                align_corners=True,
            )
