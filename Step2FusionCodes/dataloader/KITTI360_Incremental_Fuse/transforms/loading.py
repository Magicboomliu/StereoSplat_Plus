...
def get_timestep_infos(datapath,
    ...
    data_dict['imgs'] = imgs
    data_dict['cks'] = cks.float()
    data_dict['psuedo_depth'] = depths_ms.float()
    data_dict["sparse_gts"] = sparse_gts.float()
    
    data_dict['cam_to_lidar'] = cam_to_lidar.float()
    
    data_dict['lidar_to_world'] = lidar_to_world.float()
