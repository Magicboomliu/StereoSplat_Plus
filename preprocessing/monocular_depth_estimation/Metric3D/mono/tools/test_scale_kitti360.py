...
from mono.utils.do_test_custom import do_scalecano_test_with_custom_data
...
def parse_args():
    ...
    parser.add_argument('--show_dir', help='the dir to save logs and visualization results')
...
def main(args):
    ...
    if args.dataset_root_path is not None:
    ...
    cfg.batch_size = args.batch_size  #1
