...
sequence_name="All"
CUDA_VISIBLE_DEVICES=3 python mono/tools/kitti360_dataset_format_organization.py \
            --root_path $root_path \
...
STEP2(){
CUDA_VISIBLE_DEVICES=3 python mono/tools/test_scale_kitti360.py \
    ...
    --test_data_path /home/zliu/Project2025/FeedStereoGS/preprocessing/monocular_depth_estimation/Metric3D/data/kitti360_demo/test_annotations.json \
    --show_dir "/data1/StereoDatasets/KITTI/KITTI360/monocular_depth/Metric3DV2_Complete/" \
    --launcher None \
